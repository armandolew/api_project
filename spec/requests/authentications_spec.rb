...
RSpec.describe "/authentications", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get authentications_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Authentication" do
        expect {
          post authentications_url,
               params: { authentication: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Authentication" do
        expect {
          post authentications_url,
               params: { authentication: invalid_attributes }, as: :json
        }.to change(Authentication, :count).by(0)
      end

      it "renders a JSON response with errors for the new authentication" do
        post authentications_url,
             params: { authentication: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested authentication" do
        ...
        patch authentication_url(authentication),
              params: { authentication: new_attributes }, headers: valid_headers, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested authentication" do
      authentication = Authentication.create! valid_attributes
      expect {
        delete authentication_url(authentication), headers: valid_headers, as: :json
      }.to change(Authentication, :count).by(-1)
    end
  end
end
